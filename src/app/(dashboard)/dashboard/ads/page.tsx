    ...
    <div className="space-y-6 mb-20">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div className="flex flex-col gap-1">
          ...
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">Ads Performance</h1>
          <p className="text-sm text-slate-500">ROAS, Ads Spend, CPP, dan metrik iklan digital.</p>
        </div>
